...
export default {
    name: 'esv',
    aliases: [],
    description: 'Fetches a specific Bible verse from the English Standard Version (ESV) translation.',
    isPremium: false,
    groupOnly: false,
    privateOnly: false,
    adminOnly: false,
    ...
    async execute(sock, message, args) {
        ...
        // Hardcode the translation to ESV
        const apiUrl = `https://bible-api.com/${encodeURIComponent(query)}?translation=esv`;
        ...
        try {
            ...
            console.error('ESV command error:', error);
            await sock.sendMessage(from, {
